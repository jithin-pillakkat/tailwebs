...
<div class="card mt-3">
    <div class="card-header ">
        <div class="card-title fw-3">
            <h5 class="d-inline">STUDENTS NORMAL TABLE</h5>
                ...
                <tbody id="studetData">
                    <?php foreach ($students as $student): ?>
                        <tr id="<?= $student->id ?>">
                            ...
                            <td>
                                <button type="button" class="btn btn-light btn-sm editBtn"><i class="bi bi-pencil-square"></i></button>
                                <button type="button" class="btn btn-light btn-sm deleteBtn"><i class="bi bi-trash"></i></button>
...
$(document).ready(function(){
    ...
    $('.saveBtn').on('click',function(){
        ...
        $.ajax({
            type:'POST',
            url:"<?= route_to('normal.table.action')?>",
            dataType: "json",
